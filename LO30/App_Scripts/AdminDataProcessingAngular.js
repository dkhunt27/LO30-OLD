var ngModule = angular.module("ngAdminDataProcessingModule", ['ngRoute', 'ngResource']);
...
ngModule.factory("adminDataProcessingService", ["$resource", function ($resource) {
...
ngModule.controller('adminDataProcessingController', ['$scope', 'adminDataProcessingService', function ($scope, adminDataProcessingService) {
  $scope.dataModel = {
    action: "n/a",
    seasonId: 54,
    playoff: false,
