...
namespace LO30.Data
{
  public class ScoreSheetEntryPenaltyProcessed
  {
    ...
    public static List<ScoreSheetEntryPenaltyProcessed> LoadListFromJsonFile(string filePath)
    {
      string className = "ScoreSheetEntryPenaltyProcessed";
      string functionName = "LoadFromJsonFile";
      List<ScoreSheetEntryPenaltyProcessed> output = new List<ScoreSheetEntryPenaltyProcessed>();
