...
namespace LO30.Data.Objects
{
  public class PlayerRating
  {
    ...
    // TODO: remove once all players have rating in db
    public PlayerRating(int sid, int pid, int symd, int eymd)
      : this(sid, pid, symd, eymd, _posDefault, _rpDefault, _rsDefault, _lineDefault)
    {
    }
